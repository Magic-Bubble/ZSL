...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='save/gat-relation')
    ...
    gcn = GAT(n, edges, weights, word_vectors, word_vectors.shape[1], fc_vectors.shape[1], hidden_layers, tlist).cuda()

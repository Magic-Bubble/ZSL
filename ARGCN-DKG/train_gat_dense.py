...
from models.gat_dense import GAT_Dense
...
if __name__ == '__main__':
    ...
    gat = GAT_Dense(n, edges, word_vectors.shape[1], fc_vectors.shape[1], hidden_layers, tlist).cuda()
